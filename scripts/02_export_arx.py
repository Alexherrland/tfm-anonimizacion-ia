...
Genera arx_kit/arx_train.csv, arx_kit/arx_test.csv y los cinco
archivos de jerarquía en arx_kit/arx_hierarchies/. El paso de
anonimización se realiza manualmente en ARX Desktop según la
guía descrita en la memoria.
...
def main() -> None:
    ...
    print(f"CSVs exportados a {config.DATA_DIR}")
    ...
    print("exportar cada resultado como arx_kit/arx_output_k<k>.csv (sep=';').")
